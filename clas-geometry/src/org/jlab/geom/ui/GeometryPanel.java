...
public class GeometryPanel extends JPanel {
    ...
    private int[] translayeCoordinates(double x, double y){
    ...
    private void doDrawing(Graphics g) {
        ...
        for(Line3D line : lines){
            int[] coords_o = this.translayeCoordinates(line.origin().x(), 
                    line.origin().y());
            int[] coords_e = this.translayeCoordinates(line.end().x(), 
                    line.end().y());
